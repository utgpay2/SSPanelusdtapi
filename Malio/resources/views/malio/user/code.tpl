                      ...
                      <div class="col-sm-12 {if $config['payment_system'] != 'f2fpay'}col-md-7{else}col-md-3{/if}">
                        <div class="selectgroup w-100">
                          ...
                          {else}
                            ...
                            {/if}
                            {if $malio_config['mups_token188'] != 'none'}
                            <label class="selectgroup-item">
                              <input type="radio" name="payment" value="token188" class="selectgroup-input wechat-pay">
                              <span class="selectgroup-button selectgroup-button-icon"><i class="malio-wechat-pay mr-1" style="vertical-align: -1px"></i>USDT.TRC20</span>
                            </label>
                            {/if}
                          {/if}
                        </div>
